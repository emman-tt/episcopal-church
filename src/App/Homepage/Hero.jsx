  ...
  return (
    <section className='w-full h-full px-6 md:pl-20 pt-10 text-white'>
      <section className=' flex flex-col w-full md:w-[60%]'>
        ...
        <h2
          ref={headerText}
          className='text-4xl md:text-6xl font-semibold mt-8 leading-tight'
        >
          Welcoming Environment for
        </h2>
        <p
          ref={secondText}
          className='text-4xl md:text-6xl font-light mt-5 leading-tight'
        >
        ...
        <div className='flex flex-col sm:flex-row gap-4 md:gap-6 mt-8 md:mt-6 text-xs md:text-sm font-light'>
          <NavLink to={'/verses'}
            ...
            className='p-4 px-5 cursor-pointer text-center rounded-2xl border-white hover:border-0 border hover:bg-[#8f3337] w-full sm:w-auto'
          >
            TODAY'S VERSES
          </NavLink>
          <NavLink to={'/arts'} className='p-4 px-5 cursor-pointer text-center rounded-2xl border-white hover:border-0 border hover:bg-[#8f3337] w-full sm:w-auto'>
            VIEW OUR MEDIA
          </NavLink>
        </div>
      </section>
